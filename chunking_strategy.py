...
DEFAULT_MARKDOWN_PATH = "/data/parsed_papers/Baloch_2022.md"
...
def build_chunks_from_paper(paper: ParsedPaper, max_chars: int) -> list[dict[str, Any]]:
    """build_chunks
    Takes a rich ParsedPaper object and returns structure-aware chunks 
    that RETAIN page numbers and section context.
    """
        ...
        for part_index, body_chunk in enumerate(body_chunks):
            ...
            chunks.append({
                ...
                "metadata": {
                    **document_metadata,
                    "section": heading,
                    "page_number": section.page_start,  # <--- THIS IS THE WINNING KEY
                    "chunk_type": "section",
...
def main() -> None:
    ...
    chunks = build_chunks_from_paper(args.markdown_path, args.max_chars)
